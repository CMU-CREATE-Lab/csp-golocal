class Admin::BusinessSocialMediaSitesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @business_social_media_site.update(business_social_media_site_params)
        format.html { redirect_to (@business ? admin_business_business_social_media_sites_path(@business) : admin_businesses_path), notice: "Business Social Media Site was successfully updated." }
      else
  ...
  def create
    ...
    respond_to do |format|
      if @business_social_media_site.save
        format.html { redirect_to (@business ? admin_business_business_social_media_sites_path(@business) : admin_businesses_path), notice: "Keyword was successfully created." }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_business_business_social_media_sites_path(@business), notice: "Business Social Media Site was successfully destroyed." }
    end
  end
